...
#' @export
#' @returns No return value, called for side effects: if USAboundariesData is
#'   not installed or a newer version is required, a console message will appear
#'   asking to install USAboundariesData. Else nothing will return.
...
#' @export
#' @return No return value, called for side effects: if USAboundariesData is not
#'   installed, it will ask the user if they want to install it. If user selects
#'   "yes" then it will be installed. If no, abort.
